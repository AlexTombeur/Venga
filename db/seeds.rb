...
maxime = Trainer.create!(name:"", surname:"Maxime", description:"Personal trainer certifié, Maxime partage sa passion pour le sport à travers les meilleures salles de fitness de la capitale, à domicile et sur votre lieu de travail depuis plus de 7 ans. Lui faire confiance, c’est vous faire confiance.", address:"Bruxelles", email:"maximeswennen@gmail.com", phone:"0494/85.42.04", specialities:"Fonctionnel fitness tonification affinement puissance", remote_photo_url:"http://res.cloudinary.com/dskagnrtl/image/upload/v1486386664/1506329_1446974325524541_769729264_o_uktwjx.jpg")
...
review9 = Review.create!(description:"Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise en page avant impression. Le Lorem Ipsum est le faux texte standard de l'imprimerie depuis", client_name:"Cheryl A", trainer: Trainer.fourth)
review10 = Review.create!(description:"Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise en page avant impression.", client_name:"Claude F", trainer: Trainer.fourth)

review11 = Review.create!(description:"Chloé est une vrai professionnelle du training personnel. Pendant la séance elle m'encourage constamment et les entraînements avec elle m'ont redonné l'energie et l'envie de bouger. Grâce à elle j'ai pu accepter et dépasser mes limites.", client_name:"Maria Cervatiuc", trainer: Trainer.fifth)
